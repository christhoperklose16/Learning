...
import (
	"christhoper_50420309_pert3/model"
	"database/sql"
	"fmt"
	"testing"
)
...
func init() {
	...
	password = ""
	host = "localhost"
	namaDB = "christhoper_50420309_pert3"
	defaultDB = "mysql"
}
...
func TestDatabase(t *testing.T){
	...
	/* Function Testing dibawah ini berfungsi untuk menghapus DB (Apabila ingin melakukan testing, silahkan di comment terlebih dahulu. Abaikan apabila telah ter -comment)*/
